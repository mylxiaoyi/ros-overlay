...
SRC_URI="https://github.com/gazebosim/gz-rendering/archive/refs/tags/gz-rendering7_${PV}.tar.gz -> ${P}.tar.gz"

S=${WORKDIR}/gz-rendering-gz-rendering7_${PV}
