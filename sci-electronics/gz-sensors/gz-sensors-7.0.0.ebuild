...
SRC_URI="https://github.com/gazebosim/gz-sensors/archive/refs/tags/gz-sensors7_${PV}.tar.gz -> ${P}.tar.gz"

S=${WORKDIR}/gz-sensors-gz-sensors7_${PV}
